...
namespace eng
{
    public partial class engfree2 : Form
    {
        public engfree2()
        {
            InitializeComponent();
        ...
        int soruadeti, x = 0, y, süretoplam, sürepersoru, zaman;
        int başlasayaç;
        int doğru, yanlış;
        ...
        void kelimegetir()
        {
            ...
            else
            {
                ...
                while (oku.Read())
                {
                    textBox1.Text = oku["türkçe"].ToString();
                }
                baglanti.Close();
            }
        }
        private void sıradaki_Click_1(object sender, EventArgs e)
        {
            zaman = 0;
            timer1.Start();
            timer2.Start();
        ...
        private void engfree2_Load(object sender, EventArgs e)
        {
        ...
        private void engfree2_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        private void cevapla_Click(object sender, EventArgs e)
        {
            if (checkfirsttext == true)
            {
                ...
                else
                {
                    ...
                    while (oku.Read())
                    {
                        if (textBox2.Text == oku["ingilizce"].ToString())
                        {
                            doğru++;
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            if ((doğru + yanlış) == 0)
            {
                MessageBox.Show("Hiç soru çözülmemiş");
            }
            else
            {
                timer1.Stop();
